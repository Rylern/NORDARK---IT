...
public class IESReader
{
    ...
    public int m_VerticalAngleCount;
    public int m_HorizontalAngleCount;
    public float[] m_VerticalAngles;
    public float[] m_HorizontalAngles;
    public float[] m_CandelaValues;
