...
namespace GeoJSON.Net.Converters
{
    ...
    public class PointEnumerableConverter : JsonConverter
    {
        ...
        {
            var points = (IEnumerable<GeoJSON.Net.Geometry.Point>) value;
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            return coordinates.Select(position => new GeoJSON.Net.Geometry.Point(position.ToObject<IEnumerable<double>>().ToPosition()));
        }
